                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label style="display: block; margin-bottom:0px;">
                                        <input type="checkbox"  onchange="daftarulang('{{$siswa->id}}')" {{!empty($pendaftaran->daftar_ulang) ? 'checked' : '' }}  ><span class="flip-indecator" data-toggle-on="Sudah" data-toggle-off="Belum"></span>
                                    </label>
                                    </div>    
                                </td>
                            </tr>
